...
<h3> 009_Modul - Selenium </h3>

- First1 file

    - Завдання 1
    > с сайта https://www.marvel.com/ с блока "THE LATEST" спарсить название статей и категорию.
Результат записать в файл. Пример в файле marvel.
